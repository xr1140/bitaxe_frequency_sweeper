def calculate_voltage(frequency):
    ...
    Note: Voltage model is based on data for 900–1100 MHz and extrapolated for other frequencies.
    """
    if 400 <= frequency <= 1300:
        voltage_mv = 0.492 * frequency + 802.6  # Voltage in millivolts
